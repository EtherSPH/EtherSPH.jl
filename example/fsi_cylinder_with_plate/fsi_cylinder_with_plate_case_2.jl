...
setFileName!(vtp_writer, "fsi_cylinder_with_plate_case_2_")
setOutputPath!(vtp_writer, "example/results/fsi_cylinder_with_plate/fsi_cylinder_with_plate_case_2")
@info "$vtp_writer"
...
function post()::Nothing
    ...
    post_process = FSICylinderWithPlatePostProcess(key_word = "case_2")
    post_process.viewPlot()
    post_process.curvePlot()
    return nothing
end
