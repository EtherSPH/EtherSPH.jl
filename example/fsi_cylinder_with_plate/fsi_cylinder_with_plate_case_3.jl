...
setFileName!(vtp_writer, "fsi_cylinder_with_plate_case_3_")
setOutputPath!(vtp_writer, "example/results/fsi_cylinder_with_plate/fsi_cylinder_with_plate_case_3")
@info "$vtp_writer"
...
function post()::Nothing
    ...
    post_process = FSICylinderWithPlatePostProcess(key_word = "case_3")
