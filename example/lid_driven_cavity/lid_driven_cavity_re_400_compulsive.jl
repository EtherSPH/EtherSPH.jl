...
const p_0 = c^2 * rho_0 * 0.003 # background pressure
...
vtp_writer.file_name_ = "lid_driven_cavity_re_400_compulsive_"
vtp_writer.output_path_ = "example/results/lid_driven_cavity/lid_driven_cavity_re_400_compulsive/"
