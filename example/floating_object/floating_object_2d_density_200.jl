...
vtp_writer.file_name_ = "floating_object_2d_density_200_"
vtp_writer.output_path_ = "example/results/floating_object/floating_object_2d_density_200"
...
function post()::Nothing
    ...
    post_process = FloatingObjectPostProcess(key_word = "2d_density_200")
