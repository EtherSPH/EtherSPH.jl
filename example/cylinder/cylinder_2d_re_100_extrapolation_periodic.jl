...
@inline function continuityAndPressureExtrapolation!(p::Particle, q::Particle, rpq::Vector2D, r::Float64)::Nothing
    ...
    elseif p.type_ in (WALL_TAG, CYLINDER_TAG) && q.type_ == FLUID_TAG
        kernel_weight = W(r) * q.mass_ / q.rho_
...
vtp_writer.file_name_ = "cyliner_2d_re_100_extrapolation_periodic_"
vtp_writer.output_path_ = "example/results/cylinder/cylinder_2d_re_100_extrapolation_periodic"
...
function post()::Nothing
    ...
    post_process = Cylinder2DPostProcess(key_word = "re_100_extrapolation_periodic")
