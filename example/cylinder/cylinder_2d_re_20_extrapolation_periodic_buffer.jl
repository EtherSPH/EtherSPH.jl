...
vtp_writer.file_name_ = "cyliner_2d_re_20_extrapolation_periodic_buffer_"
vtp_writer.output_path_ = "example/results/cylinder/cylinder_2d_re_20_extrapolation_periodic_buffer"
...
function post()::Nothing
    ...
    post_process = Cylinder2DPostProcess(key_word = "re_20_extrapolation_periodic_buffer")
