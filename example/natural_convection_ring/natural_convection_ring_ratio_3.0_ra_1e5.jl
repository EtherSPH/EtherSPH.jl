...
vtp_writer.file_name_ = "natural_convection_ring_ratio_3.0_ra_1e5_"
vtp_writer.output_path_ = "example/results/natural_convection_ring/natural_convection_ring_ratio_3.0_ra_1e5"
...
function post()::Nothing
    ...
    post_process = NaturalConvectionRingPostProcess(key_word = "ratio_3.0_ra_1e5", rayleigh_number = "1e5")
